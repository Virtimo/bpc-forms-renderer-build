/**
 * German translation with manuell changes:
 *  - fixed required message (in .Field & .Text): Dieses Feld darf nicht leer sein
 *  - number function: previously applying the locale file a second time, crashed ExtJS
 */
